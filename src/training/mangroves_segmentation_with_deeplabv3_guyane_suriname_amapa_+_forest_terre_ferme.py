...
OUT_DIR = BASE2 / "Mangrove_CROMA_Project/data/segmentation_binaire_deeplabv3+_guyane_suriname_amapa_v2"
...
class DeepLabV3Plus_S1S2(nn.Module):
    def __init__(self, weight_path=None):
        ...
        self.backbone = ResNet50BigEarthNetBackbone(
...
class FocalDiceLoss(nn.Module):
    ...
    def __init__(self, alpha=0.75, gamma=1, pos_weight=4.0, smooth=1e-6):
        super().__init__()
        self.alpha = alpha
        self.gamma = gamma
        self.smooth = smooth
